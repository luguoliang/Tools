...
#import "LGLSlideTransitionDelegate.h"
#import "LGLSlideTransitionAnimator.h"
#import "LGLSlideTransitionInteractionController.h"
...
const char * LGLSlideTabBarControllerDelegateAssociationKey = "LGLSlideTabBarControllerDelegateAssociation";

@interface LGLSlideTransitionDelegate ()
@property (nonatomic, strong) UIPanGestureRecognizer *panGestureRecognizer;
@end
@implementation LGLSlideTransitionDelegate
//| ----------------------------------------------------------------------------
...
- (void)setTabBarController:(UITabBarController *)tabBarController
{
    if (tabBarController != _tabBarController) {
        ...
        // controller.
        objc_setAssociatedObject(_tabBarController, LGLSlideTabBarControllerDelegateAssociationKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(_tabBarController, LGLSlideTabBarControllerDelegateAssociationKey, self, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (id<UIViewControllerAnimatedTransitioning>)tabBarController:(UITabBarController *)tabBarController animationControllerForTransitionFromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC
{
    ...
    if ([viewControllers indexOfObject:toVC] > [viewControllers indexOfObject:fromVC]) {
        ...
        return [[LGLSlideTransitionAnimator alloc] initWithTargetEdge:UIRectEdgeLeft];
    } else {
        // The incoming view controller precedes the outgoing view controller,
        // slide towards the right.
        return [[LGLSlideTransitionAnimator alloc] initWithTargetEdge:UIRectEdgeRight];
    }
}
...
- (id<UIViewControllerInteractiveTransitioning>)tabBarController:(UITabBarController *)tabBarController interactionControllerForAnimationController:(id<UIViewControllerAnimatedTransitioning>)animationController
{
    ...
    if (self.panGestureRecognizer.state == UIGestureRecognizerStateBegan || self.panGestureRecognizer.state == UIGestureRecognizerStateChanged) {
        return [[LGLSlideTransitionInteractionController alloc] initWithGestureRecognizer:self.panGestureRecognizer];
    } else {
